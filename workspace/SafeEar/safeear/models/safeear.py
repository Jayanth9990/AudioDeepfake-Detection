...
from .tfc_reduction import TFCModule
...
class SE_Rawformer_front(nn.Module):
    def __init__(self, conv1 = [2,3,1,1,1,1],conv2 = [3,3,1,1,1,2],conv3 = [1,3,0,1,1,2]):
        ...
        from .tfc_reduction import TFCModule
        self.temporal_reduction = TFCModule(64)
    import time   # add at top of file (only once)
    ...
    def forward(self, x, Freq_aug=False):
        ...
        encoder = self.temporal_reduction(encoder)

        print("Forward Time:", time.time() - start)   # ⬅️ END TIMER
