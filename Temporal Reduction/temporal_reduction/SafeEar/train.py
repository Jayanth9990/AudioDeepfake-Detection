...
def train(cfg: DictConfig) -> Tuple[Dict[str, Any], Dict[str, Any]]:
    ...
    if cfg.speechtokenizer_path:
        print("Loading pretrained SpeechTokenizer...")
        decouple_model.load_state_dict(torch.load(cfg.speechtokenizer_path))
    else:
        print("No pretrained tokenizer provided. Training from scratch.")
    print("Skipping pretrained SpeechTokenizer loading")
    ...
    if cfg.get("checkpoint"):
        ...
        checkpoint: pl.callbacks.ModelCheckpoint = hydra.utils.instantiate(
            cfg.checkpoint
        )
